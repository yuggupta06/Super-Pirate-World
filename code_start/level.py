...
class Level:
    def __init__(self,tmx_map,level_frames,audio_files,data,switch_stage,items_dissapear):
    ...
    def box_items(self,font_size,content,color,pos,):
        ...
        pygame.draw.rect(self.display_surface,"green",box_icons_rect,0,10)
    ...
    def pause_box(self):
        ...
        pause_surf=pause_font.render("Pause Menu",True,"orange")
        pause_rect=pause_surf.get_frect(center=(WINDOW_WIDTH/2,WINDOW_HEIGHT/6))
        self.display_surface.blit(pause_surf,pause_rect)
        pygame.draw.rect(self.display_surface,"#98BF64",pygame.Rect((WINDOW_WIDTH/2-90,WINDOW_HEIGHT/2.5-40),(200,300)),0,20)
